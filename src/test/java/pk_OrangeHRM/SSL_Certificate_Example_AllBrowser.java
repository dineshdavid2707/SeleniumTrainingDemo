...
public class SSL_Certificate_Example_AllBrowser {
	WebDriver driver;
	 ...
	 * ChromeOptions // setting system property for Chrome browser
	 * WebDriverManager.chromedriver().setup(); // create Google Chrome instance and
	 * maximize it driver = new ChromeDriver(options);
    ...
    public void LaunchBrowserChrome() {
         // Create object of DesiredCapabilities class
			/* This line needs to used in Selenium Java below 4.2.0
